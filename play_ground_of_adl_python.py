# -*- coding: utf-8 -*-
"""Play Ground of ADL_Python.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/13hcOZEjOcFSmewB3RzLotLxbLO6V4-V-
"""
...
if __name__ == "__main__":
    ...
    #adding the repository where we save the dataset
    # os.system('git clone https://github.com/SeptivianaSavitri/adl_python.git')
